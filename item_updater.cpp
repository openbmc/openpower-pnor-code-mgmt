...
bool ItemUpdater::isChassisOn()
{
    ...
    if (mapperResponseMsg.is_method_error())
    {
        ...
        elog<InvalidArgument>(Argument::ARGUMENT_NAME("GetObject"),
                              Argument::ARGUMENT_VALUE(CHASSIS_STATE_OBJ));
    }
    ...
    if (mapperResponse.empty())
    {
        ...
        elog<InvalidArgument>(Argument::ARGUMENT_NAME("MapperResponseMsg"),
                              Argument::ARGUMENT_VALUE(CHASSIS_STATE_OBJ));
    }
    ...
    if (response.is_method_error())
    {
        ...
        elog<InvalidArgument>(Argument::ARGUMENT_NAME("Response"),
