 ...
 * @param[out] versionStruct - The struct to be populated
 */
static void parse(const std::string& version, Version_t& versionStruct)
{
    std::smatch match;
    ...
    {
        // Populate Z
        versionStruct.rev = std::stoi(match[3]);
    }
    versionStruct.major = std::stoi(match[1]);
    versionStruct.minor = std::stoi(match[2]);
}
