 ...
 * 
 * Device provide RAII managed wrapper to device file descriptor to manage and access MMIO
 * regions for the file descriptor
 * 
 * @details
 * Device optionally take the ownership of file descriptor but can be managed manually.
 * Device can't be copied or assigned.
 * 
 */
class Device
{
